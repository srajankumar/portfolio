    ...
    <div>
      <div className="lg:px-16 px-5">
        <form
          ...
          className=" h-screen flex justify-between flex-wrap"
        >
          <div className="md:w-1/2 md:mt-0 md:py-0 py-10 mt-20 w-full items-center flex flex-col justify-center">
            <div className="md:text-xl md:w-auto w-full font-normal">
              ...
              <div className="bg-neutral-700 px-10 rounded-3xl text-base py-8 text-white">
          ...
          <div className="w-full md:w-1/2 md:px-5 px-0 items-center rounded-lg overflow-hidden flex relative">
