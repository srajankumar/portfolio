...
const About = () => {
  return (
    <div className="min-h-screen md:px-20 lg:px-40 px-5 flex justify-center md:flex-row flex-col items-center">
      <div className="min-h-96 md:w-1/2 flex flex-col">
        <div className="bg-black py-7 px-10 text-lg rounded-3xl">
          <div className="content">
            <div className="text-2xl tracking-widest gothamB title">
        ...
        <div className="bg-gray-100 text-black px-10 py-7 text-lg rounded-3xl">
          <h1 className="mb-6 font-gothamB md:text-lg text-xl">
            I&apos;m Srajan Kumar,
          </h1>
          <p className="font-gothamL text-base">
            a second-year Computer Science Engineering student at Sahyadri
            College of Engineering and Management. Aiming to be a cool
            full-stack React and MERN developer and also explore other tech
      ...
      <div className="md:w-1/2">
        <div className="bg-gradient-to-b from-[#232323] to-black bg-opacity-50 text-white min-h-96 rounded-3xl px-10 py-7">
          <h1 className="font-gothamB md:text-xl text-2xl">My tech stacks</h1>
          <div className="flex flex-wrap">
            ...
            <Link
              className="text-white ease-in transition duration-300 p-0 pt-5 pr-5"
              href="https://stackoverflow.com/users/21259173/srajan"
              target="_blank"
            >
              <svg
        ...
        <div className="bg-cyan-400 min-h-96 text-black rounded-3xl px-10 py-7">
          <h1 className="font-gothamB md:text-xl text-2xl">Plan to Learn</h1>
          <div className="flex flex-wrap">
            <Link
              href="https://github.com/srajankumar"
              className="ease-in transition duration-300 p-0 pt-5 pr-5"
            ...
            <Link
              className="text-black ease-in transition duration-300 p-0 pt-5 pr-5"
              href="https://www.instagram.com/withpainsimon/"
              target="_blank"
            >
              <svg
            ...
            <Link
              className="text-green-600 ease-in transition duration-300 p-0 pt-5 pr-5"
              href="https://twitter.com/kumarsrajan02"
              target="_blank"
            >
              <svg
            ...
            <Link
              className="text-pink-500 ease-in transition duration-300 p-0 pt-5 pr-5"
              href="http://discordapp.com/users/withpainsimon#7119"
              target="_blank"
            >
              <svg
